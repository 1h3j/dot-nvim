if vim.g.neovide then
	vim.o.guifont = "SpaceMono Nerd Font:h11"
	vim.g.neovide_padding_top = 26
	vim.g.neovide_padding_bottom = 26
	vim.g.neovide_padding_left = 26
	vim.g.neovide_padding_right = 26
	vim.opt.linespace = 0
